...
<div class="flex min-h-screen">
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" 
        ...
        <nav class="mt-4">
            <ul class="space-y-2">
                <li>
                    <a href="{{ route('atasan.pengajuan') }}" class="block px-6 py-3 hover:bg-blue-100 text-gray-700 font-medium">Kelola Pengajuan Izin</a></li>
                <li>
                    <a href="{{ route('atasan.histori') }}" class="block px-6 py-3 hover:bg-blue-100 text-gray-700 font-medium">Histori Izin</a></li>
                <li>
                    <a href="{{ route('atasan.dashboard') }}" class="block px-6 py-3 hover:bg-blue-100 text-gray-700 font-medium">
                        Dashboard
                    </a>
                </li>
                <li>
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="w-full text-left px-6 py-3 hover:bg-red-100 text-red-600 font-medium">Logout</button>
                    </form>
                </li>
            </ul>
        </nav>
