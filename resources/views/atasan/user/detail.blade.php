        ...
        <div class="bg-white overflow-hidden shadow-xl rounded-2xl">
            ...
            <div class="bg-green-600 px-6 py-5 border-b border-green-700 rounded-t-2xl">
                <div class="flex items-center justify-between">
                    <h2 class="text-2xl font-bold text-white">Detail Pengguna</h2>
                    <a href="{{ route('atasan.user.index') }}" class="flex items-center text-green-100 hover:text-white transition-colors">
