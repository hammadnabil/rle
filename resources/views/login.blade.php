        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-4 sm:space-y-5">
            ...
            <div>
                ...
                <select name="role" required
                    class="w-full mt-1 px-3 py-2 sm:px-4 sm:py-2 rounded-lg border border-gray-300 bg-white focus:ring-2 focus:ring-indigo-500 focus:outline-none text-sm sm:text-base">
